...
echo ""
echo "GitHub Actions: Settings → Actions → General → Workflow permissions"
echo "  - Read and write permissions"
echo "  - Allow GitHub Actions to create and approve pull requests"
echo ""
echo "Cursor Cloud Agent: do NOT use ManagePullRequest (opens PRs as you)."
echo "  Push to cursor/* and let .github/workflows/cursor-branch-pull-request.yml open the PR."
